...
\begin{workout}[Bilancio energetico: sorgenti energetiche, equilibrio radiativo, luminosit\'a pianeta.]
...
\begin{workout}[Modello di pianeta (equazioni fondamentali)]\end{workout}
\end{frame}

\begin{frame}{Constrain Modello}
\begin{workout}[Constrains osservativi]\end{workout}
\end{frame}
