...
display columns/1/.style={column name={mass},clear infinite},
display columns/2/.style={column name={mass(Earth)},string type},
display columns/3/.style={column name={R},clear infinite},
display columns/4/.style={column name={$\bar{\rho}$},clear infinite},
display columns/5/.style={column name={$g_s$},clear infinite},+
display columns/6/.style={column name={$J_2$},clear infinite},
