...
\pgfplotstableread{dwaqrfplanets.txt}\dwarfplanets




\begin{table}[!ht]
\pgfplotstabletypeset[skip rows between index={2}{26},
...
display columns/2/.style={column name={R (Km)},string type},
display columns/3/.style={column name={mass \SI{e15}{\kilo\gram}},clear infinite},
display columns/4/.style={column name={$P_{rot} (hrs)$,clear infinite},
display columns/5/.style={column name={P (yrs)},clear infinite},
display columns/6/.style={column name={a},clear infinite},
display columns/7/.style={column name={e},clear infinite},
display columns/8/.style={column name={i (deg)},clear infinite},
columns/planets/.style={string type},
columns={Asteroid, R, mass, spin, P, a, e, i},
