...
\begin{figure}[!ht]
\begin{subfigure}[b]{0.47\textwidth} \centering \includegraphics[trim={0cm 0 0 0},clip, width=0.49\textwidth]{PMfreq-e23} \label{fig:PMfreq-e23} \end{subfigure}
~
...
\begin{figure}[!ht]\includegraphics[trim={0cm 0cm 0 0},clip, keepaspectratio,height=\textheight]{PMfreq-short}\label{fig:PMfreq-short}\end{figure}
