...
<<<<<<< HEAD
\begin{figure}[!ht]
\includegraphics[trim={0cm 0 0 0},clip, width=\textwidth]{PMfreq-e23}
\end{figure}
\begin{figure}[!ht]
\includegraphics[trim={0cm 0 0 0},clip,width=\textwidth]{PMfreq-e12}\label{fig:PMfreq-e12}
\end{figure}
\begin{figure}[!ht]
\includegraphics[trim={0cm 0cm 0 0},clip, keepaspectratio,height=0.45\textheight]{PMfreqshort}\label{fig:PMfreqshort}
\end{figure}
=======

\begin{figure}[!ht] \begin{subfigure}[b]{0.47\textwidth} \centering \includegraphics[trim={0cm 0 1 0},clip, width=0.9\textwidth]{PMfreq-e12}\label{fig:PMfreq-e12} \end{subfigure} ~ \begin{subfigure}[b]{0.47\textwidth} \centering \includegraphics[trim={0cm 1 0 0},clip,width=0.9\textwidth]{PMfreq-e23}\label{fig:PMfreq-e12}\end{subfigure} \end{figure} 

>>>>>>> a31a8adf1c3a8ea05a3de43fc27b7321c5705cb5
