...
\item $\nu_6$ longitude of pericentre drift $\varpi$ drift due to Jupiter perturbation at rate $g_6\approx\SI{28.2}{arcsecon\per\year}$: truncation at \SI{2.1}{\astronomicalunit} and bent in $(a,I)$ plane.
\end{itemize}
\end{block}
\end{frame}
...
\begin{figure}[!ht]
\includegraphics[keepaspectratio,width=\textwidth]{Asdss}
\end{figure}
\end{column}
\begin{column}{0.5\textwidth}
...
\begin{frame}{Distribuzione di massa delgi asteroidi: legge di potenza.}
\begin{block}{}\end{block}
\end{frame}

\begin{wordonframe}{Distro massa A: legge di potenza.}
\begin{block}{Collisional cascade (Dohnanyi 1969)}\end{block}
