...
\begin{figure}[!ht]
\includegraphics[keepaspectratio,height=0.9\textheight]{Asdss}
\end{figure}
\end{column}
...
\end{itemize}
L'esponente nelle distro reali oscilla attorno al valore di Dohnanyi.

MB: $q<2$ ($M_{MB}\approx 3M_{Ceres}$)
\end{block}
